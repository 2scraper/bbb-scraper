...
**"bbb-scraper security"** in the subject — otherwise it lands in a queue
...
- **Bypassing BBB's bot protection.** This scraper drives an ordinary
...
- **The scraper stopped working.** BBB changing its markup is expected —
